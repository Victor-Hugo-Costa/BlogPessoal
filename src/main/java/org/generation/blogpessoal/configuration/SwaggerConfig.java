...
public class SwaggerConfig {
	...
	public OpenAPI springBlogPessoalOpenAPI() {
        ...
        return new OpenAPI()
				...
				.contact(new Contact()
					.name("Victor Hugo Costa de Souza")
					.url("https://github.com/Victor-Hugo-Costa")
					.email("victor.hcsouza@outlook.com")))
				.externalDocs(new ExternalDocumentation()
					.description("Github")
					.url("https://github.com/Victor-Hugo-Costa/BlogPessoal"));
	}
